...
import { saveUserDataAPI } from '@/api/employees'
...
export default {
  ...
  methods: {
    ...
    saveUser() {
      this.$refs.userFormRef.validate().then(async () => {
        await saveUserDataAPI({ ...this.userInfo, password: this.userInfo.password2 })
